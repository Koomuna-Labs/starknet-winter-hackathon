...
export interface IRocketStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addUint"
      | "confirmGuardian"
...
export interface IRocketStorage extends BaseContract {
  connect(runner?: ContractRunner | null): IRocketStorage;
