...
export interface IAaveUsdcInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IAaveUsdc extends BaseContract {
  connect(runner?: ContractRunner | null): IAaveUsdc;
  waitForDeployment(): Promise<this>;

  interface: IAaveUsdcInterface;
