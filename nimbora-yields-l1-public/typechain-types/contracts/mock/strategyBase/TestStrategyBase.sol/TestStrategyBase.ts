...
export interface TestStrategyBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "handleReport"
      | "initialize"
...
export interface TestStrategyBase extends BaseContract {
  connect(runner?: ContractRunner | null): TestStrategyBase;
  waitForDeployment(): Promise<this>;

  interface: TestStrategyBaseInterface;
