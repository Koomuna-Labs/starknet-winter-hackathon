...
export interface AaveUsdcStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "handleReport"
      | "initialize"
...
export interface AaveUsdcStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): AaveUsdcStrategy;
  waitForDeployment(): Promise<this>;

  interface: AaveUsdcStrategyInterface;
