...
export interface ISavingDaiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ISavingDai extends BaseContract {
  connect(runner?: ContractRunner | null): ISavingDai;
  waitForDeployment(): Promise<this>;

  interface: ISavingDaiInterface;
