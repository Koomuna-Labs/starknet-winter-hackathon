...
import type {
  StrategyBase,
  StrategyBaseInterface,
} from "../../../contracts/strategies/StrategyBase";
...
export class StrategyBase__factory {
  ...
  static createInterface(): StrategyBaseInterface {
    return new Interface(_abi) as StrategyBaseInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): StrategyBase {
    return new Contract(address, _abi, runner) as unknown as StrategyBase;
  }
}
