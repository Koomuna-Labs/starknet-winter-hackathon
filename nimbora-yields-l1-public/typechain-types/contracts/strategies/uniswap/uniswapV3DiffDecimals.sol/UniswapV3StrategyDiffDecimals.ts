...
export interface UniswapV3StrategyDiffDecimalsInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "underlyingTokenPrecision",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "yieldTokenPrecision",
    values?: undefined
  ): string;
...
export interface UniswapV3StrategyDiffDecimals extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV3StrategyDiffDecimals;
  waitForDeployment(): Promise<this>;

  interface: UniswapV3StrategyDiffDecimalsInterface;
  ...
  underlyingTokenPrecision: TypedContractMethod<[], [bigint], "view">;
  ...
  yieldTokenPrecision: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "underlyingTokenPrecision"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "yieldTokenPrecision"
  ): TypedContractMethod<[], [bigint], "view">;
