...
export interface SavingDaiStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "handleReport"
      | "initialize"
...
export interface SavingDaiStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): SavingDaiStrategy;
  waitForDeployment(): Promise<this>;

  interface: SavingDaiStrategyInterface;
